...
yum update -y
yum install -y python3 pip3 amazon-cloudwatch-agent
                ...
                "collect_list": [
                    {
                        ...
                        "log_group_name": "/aws/ec2/webapp-dev",
...
systemctl start amazon-cloudwatch-agent || echo "CloudWatch agent start failed (may need IAM permissions)"

echo "Creating systemd service..."
cat > /etc/systemd/system/webapp.service << SERVICE_EOF
[Unit]
Description=WebApp Metrics Dashboard
